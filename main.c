...
if memory read or write then index 1 if value is 1 means will write Mem[answer] to R1
if value is 2 means will write R1 into Mem[answer],
if zero means nth will be done in the memory stage.
